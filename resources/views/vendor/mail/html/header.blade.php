    ...
    <table class="header__content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
      <tr>
        <td style="width: 50%; vertical-align:top">
          <img class="logo" src="{{ config('app.url') }}/img/mail/berghoferin-logo.png" title="Berghoferin" alt="Berghoferin" height="377" width="528" style="display:block; height:auto; width: 220px;">
        </td>
